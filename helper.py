...
def download_image_advanced(url: str, folder_name: str, filename: str, proxy: str = None) -> dict:
    """
    ...
    try:
        ...
        # Configure httpx proxy if provided
        proxies = {"http://": proxy, "https://": proxy} if proxy else None

        # HTTP/2 Client configuration passing the proxy
        with httpx.Client(http2=True, headers=headers, proxy=proxies, timeout=20.0) as client:
